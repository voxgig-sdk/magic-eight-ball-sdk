...
|---|---|---|
| `ts/` | @voxgig-sdk/magic-eight-ball-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/magic-eight-ball-sdk \
      --repository voxgig-sdk/magic-eight-ball-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/magic-eight-ball-sdk` shows it, and
`npm trust revoke @voxgig-sdk/magic-eight-ball-sdk --id=<id>` removes it.
