...
// MagicEightBall SDK utility: make_options

class MagicEightBallMakeOptions
{
    ...
    public static function call(MagicEightBallContext $ctx): array
    {
        ...
        //
        // `MagicEightBallSchema::optspec()` is built from the model:
        ...
        $optspec = MagicEightBallSchema::optspec();
