...
// MagicEightBall SDK utility type

class MagicEightBallUtility
{
    ...
    public static function copy(MagicEightBallUtility $src): MagicEightBallUtility
    {
        $u = new MagicEightBallUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
