...
// MagicEightBall SDK cache feature
...
class MagicEightBallCacheFeature extends MagicEightBallBaseFeature
{
    ...
    private function _through(MagicEightBallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
