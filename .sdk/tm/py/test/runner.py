...
class MagicEightBallTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MagicEightBallTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MagicEightBallTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MagicEightBallTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
