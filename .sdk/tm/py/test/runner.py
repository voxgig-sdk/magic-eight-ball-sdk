...
class MagicEightBallTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MagicEightBallTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MagicEightBallTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MagicEightBallTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
