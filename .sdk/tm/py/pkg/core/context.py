...
from projectname_sdk.core.control import MagicEightBallControl
...
class MagicEightBallContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MagicEightBallControl()
        ...
        if isinstance(sp, MagicEightBallSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MagicEightBallResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MagicEightBallResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MagicEightBallOperation({})
    ...
    def make_error(self, code, msg):
        return MagicEightBallError(code, msg, self)
