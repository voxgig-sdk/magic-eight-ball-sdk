...
type Args struct {
	Entity string         `json:"entity" jsonschema:"magic_eight_ball"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MagicEightBallSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic-eight-ball_list",
		Description: "List records from MagicEightBall. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic-eight-ball_load",
		Description: "Load a single record from MagicEightBall. " +
...
func runOp(client *sdk.MagicEightBallSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MagicEightBallSDK, name string) (sdk.MagicEightBallEntity, error) {
	switch strings.ToLower(name) {
	case "magic_eight_ball":
		return client.MagicEightBall(nil), nil
