// Command MagicEightBall-mcp is an MCP server exposing the MagicEightBall
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MagicEightBall_list  — list records of an entity
//	MagicEightBall_load  — load a single record of an entity
//
