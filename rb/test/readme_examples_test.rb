...
#      offline in seeded test mode (MagicEightBallSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MagicEightBall_sdk.rb")
  SDK_CLASS = "MagicEightBallSDK"
