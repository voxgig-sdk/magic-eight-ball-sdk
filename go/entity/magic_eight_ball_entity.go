...
func NewMagicEightBallEntity(client *core.MagicEightBallSDK, entopts map[string]any) *MagicEightBallEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MagicEightBallEntity) GetName() string { return e.name }
...
func (e *MagicEightBallEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MagicEightBallEntity) Deleted() bool {
	return e.deleted
}


func (e *MagicEightBallEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMagicEightBallEntity(e.client, opts)
}

func (e *MagicEightBallEntity) Data(args ...any) any {
...
func (e *MagicEightBallEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MagicEightBall; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MagicEightBallEntity) DataTyped(data ...MagicEightBall) MagicEightBall {
	if len(data) > 0 {
		return typedFrom[MagicEightBall](e.Data(asMap(data[0])))
	}
	return typedFrom[MagicEightBall](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MagicEightBall (all fields
// optional at the wire level).
func (e *MagicEightBallEntity) MatchTyped(match ...MagicEightBall) MagicEightBall {
	if len(match) > 0 {
		return typedFrom[MagicEightBall](e.Match(asMap(match[0])))
	}
	return typedFrom[MagicEightBall](e.Match())
}
...
func (e *MagicEightBallEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MagicEightBallEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MagicEightBallLoadMatch and returns an MagicEightBall. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MagicEightBallEntity) LoadTyped(reqmatch MagicEightBallLoadMatch, ctrl map[string]any) (MagicEightBall, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MagicEightBall{}, err
	}
	return typedFrom[MagicEightBall](res), nil
}



func (e *MagicEightBallEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MagicEightBallEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MagicEightBallEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MagicEightBallEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MagicEightBallEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
