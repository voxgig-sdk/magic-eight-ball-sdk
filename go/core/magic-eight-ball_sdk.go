...
func (sdk *MagicEightBallSDK) OptionsMap() map[string]any {
...
func (sdk *MagicEightBallSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MagicEightBallSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MagicEightBallSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MagicEightBallSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MagicEightBallSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MagicEightBallSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MagicEightBallSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MagicEightBallSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MagicEightBallSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MagicEightBallSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MagicEightBallSDK {
	...
	sdk := NewMagicEightBallSDK(sdkopts)
	sdk.Mode = "test"
