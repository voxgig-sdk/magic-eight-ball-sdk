...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MAGICEIGHTBALL_TEST_LIVE ||
    'TRUE' === process.env.MAGICEIGHTBALL_TEST_OVERRIDE
  ) {
  ...
  m.MAGICEIGHTBALL_TEST_EXPLAIN = process.env.MAGICEIGHTBALL_TEST_EXPLAIN || m.MAGICEIGHTBALL_TEST_EXPLAIN
