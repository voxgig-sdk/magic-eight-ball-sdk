// Verifies every TypeScript snippet in the repo's root README.md both
...
//     (\`new MagicEightBallSDK(...)\` / \`MagicEightBallSDK.test(...)\` become
//     \`MagicEightBallSDK.test({ entity: ... })\`), transpiled to JS, and run
...
// rewrite real client construction (\`new MagicEightBallSDK(...)\` and any
// \`MagicEightBallSDK.test(...)\`) to a seeded test-mode client, and give
