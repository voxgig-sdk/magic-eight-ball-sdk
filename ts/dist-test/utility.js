...
function envOverride(m) {
    if ('TRUE' === process.env.MAGIC_EIGHT_BALL_TEST_LIVE ||
        'TRUE' === process.env.MAGIC_EIGHT_BALL_TEST_OVERRIDE) {
    ...
    m.MAGIC_EIGHT_BALL_TEST_EXPLAIN = process.env.MAGIC_EIGHT_BALL_TEST_EXPLAIN || m.MAGIC_EIGHT_BALL_TEST_EXPLAIN;
    return m;
}
