...
(0, node_test_1.describe)('MagicEightBallDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MagicEightBallSDK({
    ...
    (0, node_test_1.test)('direct-load-magic_eight_ball', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-magic_eight_ball', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MAGIC_EIGHT_BALL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MagicEightBallSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MAGIC_EIGHT_BALL_TEST_MAGIC_EIGHT_BALL_ENTID'];
    ...
    const client = new __1.MagicEightBallSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=MagicEightBallDirect.test.js.map