-- MagicEightBall SDK MagicEightBall entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MagicEightBallEntity = {}
MagicEightBallEntity.__index = MagicEightBallEntity


function MagicEightBallEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MagicEightBallEntity)
  self._name = "magic_eight_ball"
  self._client = client
...
function MagicEightBallEntity:get_name()
  return self._name
end


function MagicEightBallEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MagicEightBallEntity.new(self._client, opts)
end
...
function MagicEightBallEntity:mark_deleted()
  self._deleted = true
end


function MagicEightBallEntity:deleted()
  return true == self._deleted
end


function MagicEightBallEntity:data_set(args)
  if args ~= nil then
...
function MagicEightBallEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MagicEightBallEntity:match_set(args)
  if args ~= nil then
...
function MagicEightBallEntity:match_get()
...
function MagicEightBallEntity:stream(action, args, callopts)
...
---@param reqmatch MagicEightBallLoadMatch
---@param ctrl? table
---@return MagicEightBall
---@return string? err
function MagicEightBallEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MagicEightBallEntity:_run_op(ctx, post_done)
  local utility = self._utility
