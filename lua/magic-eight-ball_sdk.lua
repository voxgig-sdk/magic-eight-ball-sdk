...
require("magic-eight-ball_types")
...
local MagicEightBallSDK = {}
MagicEightBallSDK.__index = MagicEightBallSDK
...
MagicEightBallSDK._make_feature = _make_feature


function MagicEightBallSDK.new(options)
  local self = setmetatable({}, MagicEightBallSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MagicEightBallSDK:options_map()
...
function MagicEightBallSDK:get_utility()
  return Utility.copy(self._utility)
end


function MagicEightBallSDK:get_root_ctx()
  return self._rootctx
end


function MagicEightBallSDK:prepare(fetchargs)
...
function MagicEightBallSDK:direct(fetchargs)
...
-- by passing it.
function MagicEightBallSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MagicEightBallSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "MagicEightBallSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function MagicEightBallSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = MagicEightBallSDK.new(sdkopts)
  sdk.mode = "test"
