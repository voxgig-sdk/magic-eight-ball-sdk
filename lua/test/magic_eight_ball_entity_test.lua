...
describe("MagicEightBallEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MAGIC_EIGHT_BALL_TEST_MAGIC_EIGHT_BALL_ENTID JSON to run live")
      return
    end
...
function magic_eight_ball_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MAGIC_EIGHT_BALL_TEST_MAGIC_EIGHT_BALL_ENTID")
  ...
  if env["MAGIC_EIGHT_BALL_TEST_LIVE"] == "TRUE" then
