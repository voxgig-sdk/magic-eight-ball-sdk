...
describe("MagicEightBallDirect", function()
  it("should direct-load-magic_eight_ball", function()
    local setup = magic_eight_ball_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-magic_eight_ball", setup.live and "live" or "unit")
...
function magic_eight_ball_direct_setup(mockres)
