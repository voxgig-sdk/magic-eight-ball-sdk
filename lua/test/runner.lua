...
function runner.env_override(m)
  local live = runner.getenv("MAGICEIGHTBALL_TEST_LIVE")
  local override = runner.getenv("MAGICEIGHTBALL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MAGICEIGHTBALL_TEST_EXPLAIN")
