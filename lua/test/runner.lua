...
function runner.env_override(m)
  local live = runner.getenv("MAGIC_EIGHT_BALL_TEST_LIVE")
  local override = runner.getenv("MAGIC_EIGHT_BALL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MAGIC_EIGHT_BALL_TEST_EXPLAIN")
