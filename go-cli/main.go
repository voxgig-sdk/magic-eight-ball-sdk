// Command MagicEightBall-cli is a CLI + REPL for the MagicEightBall SDK,
...
const prompt = "magic-eight-ball"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "magic_eight_ball"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MAGIC_EIGHT_BALL_APIKEY (api key), MAGIC_EIGHT_BALL_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: MAGIC_EIGHT_BALL_APIKEY carries the API key and
	// MAGIC_EIGHT_BALL_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("MAGIC_EIGHT_BALL_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("MAGIC_EIGHT_BALL_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewMagicEightBallSDK(opts)
