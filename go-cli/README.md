...
AQL-driven CLI and REPL for the MagicEightBall SDK. Positional arguments are
...
```sh
go build -o magic-eight-ball-cli ./...
```
...
./magic-eight-ball-cli list magic_eight_ball
./magic-eight-ball-cli load 1 magic_eight_ball
./magic-eight-ball-cli load '{id:1}' magic_eight_ball
