...
func registerSDKWords(r *eng.Registry, client *sdk.MagicEightBallSDK) {
...
func runOp(client *sdk.MagicEightBallSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
