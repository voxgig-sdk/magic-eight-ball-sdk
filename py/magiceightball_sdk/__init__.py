...
from magiceightball_sdk.utility import register

# Load features
from magiceightball_sdk.feature.base_feature import MagicEightBallBaseFeature
from magiceightball_sdk.features import _has_feature, _make_feature
...
class MagicEightBallSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MagicEightBallUtility()
        self._utility = utility

        from magiceightball_sdk.config import shared_config
    ...
    def get_utility(self):
        return MagicEightBallUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MagicEightBallSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def MagicEightBall(self, data=None) -> "MagicEightBallEntity":
        ...
        from magiceightball_sdk.entity.magic_eight_ball_entity import MagicEightBallEntity
