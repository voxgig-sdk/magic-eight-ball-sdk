...
from magiceightball_sdk.magiceightball_types import (
    MagicEightBall,
...
class MagicEightBallEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MagicEightBallEntity(self._client, opts)
    ...
    def data_get(self) -> MagicEightBall:
    ...
    def match_get(self) -> MagicEightBall:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MagicEightBall:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MagicEightBall().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
