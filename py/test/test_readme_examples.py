# MagicEightBall SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MagicEightBallSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MagicEightBallSDK(...) and MagicEightBallSDK.test(...) become
#      MagicEightBallSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "magiceightball_sdk"
_SDK_CLASS = "MagicEightBallSDK"
...
_ENTITIES = {
    "MagicEightBall": "magic_eight_ball",
}
