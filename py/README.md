# MagicEightBall Python SDK



The Python SDK for the MagicEightBall API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.MagicEightBall()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/magic-eight-ball-sdk/releases)) or
...
```
py/
├── magiceightball_sdk.py         -- Main SDK module
