...
// MagicEightBall SDK audit feature
...
class MagicEightBallAuditFeature extends MagicEightBallBaseFeature
{
    ...
    private function _emit(MagicEightBallContext $ctx, string $outcome): void
    {
