...
// MagicEightBall SDK clienttrack feature
...
class MagicEightBallClienttrackFeature extends MagicEightBallBaseFeature
{
    ...
    public function PostConstruct(MagicEightBallContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MagicEightBall-SDK';
