...
// MagicEightBall SDK metrics feature
...
class MagicEightBallMetricsFeature extends MagicEightBallBaseFeature
{
    ...
    private function _record(MagicEightBallContext $ctx, bool $ok): void
    {
