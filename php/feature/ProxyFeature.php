...
// MagicEightBall SDK proxy feature
...
class MagicEightBallProxyFeature extends MagicEightBallBaseFeature
{
    ...
    public function init(MagicEightBallContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MagicEightBallContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
