...
// MagicEightBall SDK telemetry feature
...
class MagicEightBallTelemetryFeature extends MagicEightBallBaseFeature
{
    ...
    private function _close(MagicEightBallContext $ctx, bool $ok): void
    {
