...
// MagicEightBall SDK ratelimit feature
...
class MagicEightBallRatelimitFeature extends MagicEightBallBaseFeature
{
    ...
    private function _acquire(MagicEightBallContext $ctx): void
    {
    ...
    private function _track(MagicEightBallContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
