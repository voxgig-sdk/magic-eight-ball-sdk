...
// MagicEightBall SDK debug feature
...
class MagicEightBallDebugFeature extends MagicEightBallBaseFeature
{
    ...
    private function _finish(MagicEightBallContext $ctx, bool $ok): void
    {
