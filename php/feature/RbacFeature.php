...
// MagicEightBall SDK rbac feature
...
class MagicEightBallRbacFeature extends MagicEightBallBaseFeature
{
    ...
    private function _required(MagicEightBallContext $ctx): ?string
    {
    ...
    private function _reject(MagicEightBallContext $ctx, string $required): void
    {
    ...
    private function _track(MagicEightBallContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
