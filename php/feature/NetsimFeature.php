...
// MagicEightBall SDK netsim feature
...
class MagicEightBallNetsimFeature extends MagicEightBallBaseFeature
{
    ...
    private function _simulate(MagicEightBallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MagicEightBallContext $ctx, array $applied): void
    {
        $client = $this->client;
