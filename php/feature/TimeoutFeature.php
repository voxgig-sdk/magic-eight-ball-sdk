...
// MagicEightBall SDK timeout feature
...
class MagicEightBallTimeoutFeature extends MagicEightBallBaseFeature
{
    ...
    private function _with_timeout(MagicEightBallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MagicEightBallContext $_ctx, float $ms): void
    {
        $client = $this->client;
