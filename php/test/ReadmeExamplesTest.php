...
// MagicEightBall SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MagicEightBallSDK::test)
...
{
    private const SDK_CLASS = 'MagicEightBallSDK';
    ...
    private const SDK_BASE = 'magiceightball_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../magiceightball_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
