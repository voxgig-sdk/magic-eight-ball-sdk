...
// MagicEightBall SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MagicEightBallOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MagicEightBallOmni::structfix($now, Struct::undef()))
                        !== json_encode(MagicEightBallOmni::structfix($val, Struct::undef()))) {
