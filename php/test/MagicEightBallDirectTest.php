...
class MagicEightBallDirectTest extends TestCase
{
    public function test_direct_load_magic_eight_ball(): void
    {
        $setup = magic_eight_ball_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-magic_eight_ball", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
