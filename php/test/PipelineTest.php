...
// MagicEightBall SDK pipeline test
//
...
require_once __DIR__ . '/../magiceightball_sdk.php';
...
{
    private static function utility(): MagicEightBallUtility
    {
        return new MagicEightBallUtility();
    }
    ...
    private static function ctx(array $over = []): MagicEightBallContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MagicEightBallContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MagicEightBallOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MagicEightBallError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MagicEightBallOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MagicEightBallMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MagicEightBallOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MagicEightBallMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MagicEightBallOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MagicEightBallMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MagicEightBallSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MagicEightBallMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MagicEightBallResponse([]),
            'result' => new MagicEightBallResult([]),
        ]);
        [, $err] = MagicEightBallMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MagicEightBallSpec([]),
            'response' => null,
            'result' => new MagicEightBallResult([]),
        ]);
        [, $err] = MagicEightBallMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MagicEightBallSpec(['step' => 's']),
            'response' => new MagicEightBallResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MagicEightBallResult([]),
        ]);
        [, $err] = MagicEightBallMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MagicEightBallSpec(['step' => 's']),
            'response' => new MagicEightBallResponse(self::resp(200, ['v' => 1])),
            'result' => new MagicEightBallResult([]),
        ]);
        [, $err] = MagicEightBallMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MagicEightBallSpec(['step' => 's']),
            'response' => new MagicEightBallResponse(self::resp(200, ['v' => 2])),
            'result' => new MagicEightBallResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MagicEightBallMakeResponse::call($ctx);
    ...
    {
        $preset = new MagicEightBallResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MagicEightBallSpec([]),
            'response' => new MagicEightBallResponse([]),
            'result' => new MagicEightBallResult([]),
        ...
        [$got, $err] = MagicEightBallMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MagicEightBallResult([])]);
        [, $err] = MagicEightBallMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MagicEightBallSpec([]), 'result' => null]);
        [, $err] = MagicEightBallMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MagicEightBallSpec(['step' => 's']),
            'result' => new MagicEightBallResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MagicEightBallOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MagicEightBallMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MagicEightBallSpec(['step' => 's']),
            'result' => new MagicEightBallResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MagicEightBallOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MagicEightBallMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MagicEightBallResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MagicEightBallSpec([]),
            'result' => new MagicEightBallResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MagicEightBallMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MagicEightBallMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MagicEightBallError('boom', 'boom');
        $utility->fetcher = function (MagicEightBallContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MagicEightBallSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MagicEightBallMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MagicEightBallContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MagicEightBallMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MagicEightBallResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MagicEightBallMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MagicEightBallContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MagicEightBallSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MagicEightBallMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MagicEightBallResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MagicEightBallSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MagicEightBallMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MagicEightBallMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MagicEightBallMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MagicEightBallResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MagicEightBallDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MagicEightBallResult(['ok' => false])]);
        $this->expectException(MagicEightBallError::class);
        MagicEightBallDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MagicEightBallResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MagicEightBallMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MagicEightBallMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MagicEightBallBaseFeature();
        $b = new MagicEightBallBaseFeature();
        MagicEightBallFeatureAdd::call($ctx, $a);
        MagicEightBallFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MagicEightBallBaseFeature
    {
        $f = new MagicEightBallBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MagicEightBallFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MagicEightBallContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MagicEightBallSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MagicEightBallPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MagicEightBallPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MagicEightBallResponse(['headers' => null]),
            'result' => new MagicEightBallResult([]),
        ]);
        MagicEightBallResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MagicEightBallResultBody::call($ctx);
