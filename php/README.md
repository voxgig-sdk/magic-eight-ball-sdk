# MagicEightBall PHP SDK



The PHP SDK for the MagicEightBall API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($magiceightball->data_get());
} catch (\Throwable $err) {
...
```php
require_once 'magiceightball_sdk.php';
$client = new MagicEightBallSDK($options);
```
...
```
php/
├── magiceightball_sdk.php          -- Main SDK class
...
The main class (`magiceightball_sdk.php`) exports the SDK class
