...
class MagicEightBallSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = MagicEightBallHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = MagicEightBallHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!MagicEightBallFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, MagicEightBallFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return MagicEightBallUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = MagicEightBallHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = MagicEightBallHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = MagicEightBallHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new MagicEightBallError($op . "_allow",
                "MagicEightBallSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = MagicEightBallHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new MagicEightBallError("graphql_error",
                "MagicEightBallSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function MagicEightBall($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_magic_eight_ball === null) {
                $this->_magic_eight_ball = new MagicEightBallEntity($this, null);
            }
            return $this->_magic_eight_ball;
        }
        return new MagicEightBallEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new MagicEightBallSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
