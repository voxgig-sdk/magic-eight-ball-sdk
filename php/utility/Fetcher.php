...
// MagicEightBall SDK utility: fetcher

class MagicEightBallFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MagicEightBallSDK/1.0)';
    ...
    public static function call(MagicEightBallContext $ctx, string $fullurl, array $fetchdef): array
    {
