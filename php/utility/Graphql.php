...
// MagicEightBall SDK utility: graphql
//
...
class MagicEightBallGraphql
{
    ...
    // equivalent.
    public static function body(MagicEightBallContext $ctx): mixed
    {
    ...
    public static function errors(MagicEightBallContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
