...
// MagicEightBall SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MagicEightBallTransformResponse
{
    public static function call(MagicEightBallContext $ctx): mixed
    {
        ...
        $transform = MagicEightBallHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
